...
<body>
	...
	<header class="header menu_2">
		...
		<ul id="top_menu" class="d-none">
			...
			<li class="hidden_tablet"><a href="#" class="btn_1 rounded">Login</a></li>
		</ul>
		<!-- /top_menu -->
		...
		<nav id="menu" class="main-menu">
			<ul>
				...
				<li><span><a href="about.php">About Us</a></span>
				</li>
				<li><span><a href="#0">Services</a></span>
					<ul>
						<li><a href="service-tech.php">Bravo Tech</a></li>
						<li><a href="service-solutions.php">Bravo solutions</a></li>
						<li><a href="services-travel.php">Bravo Travels</a></li>
						<li><a href="service-supply.php">Bravo supplies</a></li>
					</ul>
				</li>
				<li><span><a href="portfolio.php">portfolio</a></span>
				<li><span><a href="contact.php">Contact</a></span>
				</li>
			</ul>
		</nav>
		<!-- Search Menu -->
